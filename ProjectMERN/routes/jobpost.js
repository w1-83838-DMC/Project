...
app.post("/",(request,response)=>{
    ...
    let queryText= `insert into jobs (provider_id,job_title,job_description,location,category_id,experienece_required,salary) values ('${provider_id}','${job_title}','${job_description}','${location}','${category_id}','${experienece_required}','${salary}')`;
    let connection= mysql2.createConnection(connectionString);
    connection.connect();
    connection.query(queryText,(err,result)=>{
        if(err==null)
